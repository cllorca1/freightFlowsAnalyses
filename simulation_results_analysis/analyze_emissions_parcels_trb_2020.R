...
folders = c("D:/simulations/foca/paper_trb_v2/muc_scenario_zero_c/",
            "D:/simulations/foca/paper_trb_v2/muc_scenario_3km/",
            "D:/simulations/foca/paper_trb_v2/muc_scenario_1km/",
            "D:/simulations/foca/paper_trb_v2/muc_scenario_paketbox/")
...
ggplot(summary, aes(y=n, x=scenario, fill = vehicle)) +
  ...
  geom_text(aes(label = n),position = position_dodge2(width = 1), vjust = -0.5, hjust = "center", family = "Arial") + 
  labs(fill = "Vehicle") + 
  theme(legend.position = "bottom")

ggsave("c:/projects/Papers/2020_TRB/fig1.bmp", width = 8, height = 7, dpi = 150, units = "cm", scale = 2)


ggplot(summary, aes(y=weight_tn, x=scenario, fill = vehicle)) +
  scale_fill_manual(values = colors_three) + 
  geom_bar(stat = "identity", position = "fill") +
  ylab("Share of parcel weight")  + 
  xlab("Scenario (area)") +
  theme_bw() + 
...
ggsave("c:/projects/Papers/2020_TRB/radLast/poster/fig2.bmp", width = 8, height = 7, dpi = 150, units = "cm", scale = 2)
...
ggplot(summary, aes(y=distance/1000, x=scenario, fill = vehicle)) +
  ...
  theme_bw() + 
  theme(text=element_text(size=14, family="Arial")) + 
  geom_text(aes(label = sprintf("%.0f",distance/1000)),position = "stack", vjust = -0.5, family = "Arial") + 
  labs(fill = "Vehicle") + 
  theme(legend.position = "bottom")

ggsave("c:/projects/Papers/2020_TRB/fig3.bmp", width = 8, height = 7, dpi = 150, units = "cm", scale = 2)
...
ggplot(summary, aes(y=distance/weight_tn/1e3, x=scenario, fill = vehicle)) +
  ...
  ylim(0,120) + 
  theme(text=element_text(size=14, family="Arial")) + 
  geom_text(aes(label = sprintf("%2.1f",distance/weight_tn/1e3)),
            position = position_dodge2(width = 1), vjust = -0.5, family = "Arial") + 
  labs(fill = "Vehicle") + 
  theme(legend.position = "bottom")

ggsave("c:/projects/Papers/2020_TRB/fig4.bmp", width = 8, height = 7, dpi = 150, units = "cm", scale = 2)
...
ggplot(summary %>% filter(vehicle!="Cargo bike"), aes(y= CO2/weight_tn/1000, x=scenario, fill = vehicle)) +
  ...
  ylim(0,80) + 
  theme(text=element_text(size=14, family="Arial")) + 
  geom_text(aes(label = sprintf("%.0f",CO2/weight_tn/1000)),position = "stack", vjust = -0.5, family = "Arial") + 
  labs(fill = "Vehicle") + 
  theme(legend.position = "bottom")

ggsave("c:/projects/Papers/2020_TRB/fig5.bmp", width = 8, height = 7, dpi = 150, units = "cm", scale = 2)
...
#   theme_bw() + 
#   theme(text=element_text(size=14, family="Arial")) +
#   geom_text(aes(label = sprintf("%.2f",NOx/weight_tn/1000)),position = "stack", vjust = -0.5, family = "Arial")
# 
...
ggplot(counts_summary %>% filter (vehicle != "Truck_LD", vehicle != "Truck_SD"), aes(y= value, x=scenario, fill = vehicle)) +
  ...
  ylim(0,70000) + 
  theme(text=element_text(size=14, family="Arial")) + 
  geom_text(aes(label = value),position = "stack", vjust = -0.5, family = "Arial") + 
  labs(fill = "Vehicle") + 
  theme(legend.position = "bottom")

ggsave("c:/projects/Papers/2020_TRB/fig6.bmp", width = 8, height = 7, dpi = 150, units = "cm", scale = 2)
