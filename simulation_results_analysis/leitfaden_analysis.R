...
vehicles$configuration = factor(vehicles$scenario, levels = c("0-REG: Reference - no cargo bike", 
                                                              "1-REG: Optimized", 
                                                              "2-MUC: Reference - no cargo bike", 
                                                              "3-MUC: Optimized"), 
...
vehicles$city = factor(vehicles$scenario, levels = c("0-REG: Reference - no cargo bike", 
                                                              "1-REG: Optimized", 
                                                              "2-MUC: Reference - no cargo bike", 
                                                              "3-MUC: Optimized"), 
                                labels = c("reg",
...
for (this_city in c("muc", "reg")){
  ...
  summary_aux2 = this_vehicles %>% left_join(simplified_emission_factors, by = "vehicle") %>% mutate(effective_share_of_ev = if_else(vehicle == "Cargo bike", 1, 0))
